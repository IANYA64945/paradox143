      ...
      if(unlocked){
        row.addEventListener('click',()=>{
          ...
          if(busyScene()){
            ...
            showSpecialHint(
              'Espera a terminar la escena actual ♡'
            );
          ...
          /*
            Al cambiar el fondo se elimina cualquier
            objetivo viejo para que nunca queden
            objetos flotando ni bloqueos invisibles.
          */
          clearPendingWeatherSecret();
          ...
          const startManual=
            ()=>{
              ...
              if(
                ...
                showSpecialHint(
                  `${CLIMATE_NAMES[type][0]} ${CLIMATE_NAMES[type][1]} fijo`
                );
              }
            };
